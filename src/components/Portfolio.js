    ...
    <section id="portfolio" className="py-20 bg-dark overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-16">
        <Parallax translateY={[-20, 20]} className="text-center mb-16">
          <h2 className="text-4xl font-bold mb-4 neon-text">Projets en Vedette</h2>
          <p className="text-gray-400">Transformer les marques par du contenu authentique</p>
        </Parallax>
      </div>
                  ...
                  >
                    <div className="space-y-4">
                      ...
                      <Link 
                        ...
                        className="inline-block mt-6 px-8 py-4 bg-white/20 hover:bg-white/30 rounded-xl text-white font-medium transition-all duration-300"
                      >
                        View Project
                      </Link>
                    </div>
